      ...
      <section className="py-[40px] md:py-[44px] lg:py-[88px] bg-white dark:bg-darkBody">
        <div className="div-container">
          ...
          <ul className="ul-list">
            ...
            <li className="p-text">
              вправи розминки імітують подальшу роботу для налаштування психіки
              в стан підвищеної готовності (концентрації). Для цього дехто
              приймає передтренувальні добавки, а можливо вистарчило б якісної
              розминки.
            </li>
          </ul>
          ...
          <p className="p-text">
            ...
            використання фітнес резинок. Активне розтягнення м’язів, які будуть
            в подальшому тренуватись.
          </p>
          <p className="p-text">
          ...
          <ul className="ul-list">
            ...
            <li className="p-text">
              ...
              назад), шийного відділів. Гіпересктензії та боковий прес в легкому
              режимі. Розтягнення грудних м'язів. Тримаючи фітнес резинку (або
              бодібар) перед собою на витягнутих руках піднімаємо і опускаємо за
              спину, стараючись не згинати руки в ліктях.
            </li>
            <li className="p-text">
              <span className="font-semibold text-mainTitle dark:text-mainTitleBlack mt-2">
              ...
              але НЕ біг). Суглобова розминка поперекового, грудного відділу,
              також коліннних, тазобедрених суглобів і стопи. Присідання, довгі
              випади вперед та/або в сторони без ваги. При становій тязі для
              розминки: гіперекстензія, сумо-підйоми (ноги значно ширше плечей,
              руками тримаємось за взуття і не відриваючи їх присідаємо -
              встаємо).
            </li>
          </ul>
          <Image
