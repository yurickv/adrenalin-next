      ...
      <section className="py-[40px] md:py-[44px] lg:py-[88px] bg-white dark:bg-darkBody">
        <div className="div-container lg:flex gap-6">
          ...
          <div>
            ...
            <p className="p-text">
              В процесі регулярних тренувань наше тіло пристосовується до певних
              навантажень і ми стаємо сильнішими, витривалішими і більш
              підкачаними (якщо достатньо їли), покращується техніка виконання
              вправ (ми сподіваємось на це). Тіло вчиться тратити менше енергії
              і менше травмуються тканини м’язів (при силовому тренінгу в
              тканинах м’язів стаються мікророзриви, які відбудовуються і
              м’язове волокно стає товстішим). Відповідно старі вправи і
              навантаження вже не дають того стимулу для розвитку. Тому{' '}
              <span className="font-semibold text-mainTitle dark:text-mainTitleBlack ">
                необхідна періодична зміна навантаження
              </span>{' '}
            ...
            <p className="p-text">
              ...
              силового навантаження, зміна вправ) і через накопичення більшої
              кількості енергетичних речовин в м’язах для роботи (збільшення
              об’єму роботи, тобто поступове збільшення підходів, кількості
              вправ на цільовий м’яз).
            </p>
            <Image
            ...
            <ul className="ul-list !list-image-none">
              <li className="p-text">
                <span className="font-semibold text-mainTitle dark:text-mainTitleBlack mt-2">
                  1. В першу чергу програму тренувань
                </span>{' '}
              ...
              <li className="p-text">
                ...
                <ul className="ul-list">
                  ...
                  <li className="p-text">
                    ...
                    м’язам і головне звязкам та суглобам «відпочити» від
                    силового періоду.
                  </li>
                </ul>
              </li>
