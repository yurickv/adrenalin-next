        ...
        <div className="div-container py-[20px] md:py-[44px] mx-auto text-center flex flex-col gap-5 md:gap-10 lg:gap-14 z-10 relative">
          <h3 className="text-left text-mainTitleBlack flex gap-2">
            ...
            <span className="font-semibold">
              ...
              <Link href="/learn/motivation">Мотивація</Link> &gt; Сила
              дисципліни
            </span>
          </h3>
        ...
        <div className="div-container lg:flex gap-6">
          ...
          <div>
            ...
            <p className="p-text">
              ...
              дисципліна. У той час як мотивація може дати поштовх вашим
              тренуванням, саме дисципліна буде підтримувати полум'я, проводячи
              вас крізь виклики та невдачі. Дисципліна закладає основу для
              довготривалого успіху та трансформації.{' '}
            ...
            <p className="p-text">
              ...
              ваших тренувань, але дисципліна - це рушійна сила, яка підтримує
              їх. Візьміть на озброєння силу дисципліни і побачите, як ваші цілі
              в спортзалі стануть не лише досяжними, але й сходинками на шляху
              до здоровішого, підтягнутішого та витривалішого вас!
            </p>
