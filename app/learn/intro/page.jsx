      ...
      <section className="bg-hero-bg bg-center bg-cover ">
        <div className="div-container py-[20px] md:py-[44px] mx-auto text-center flex flex-col gap-5">
          <h3 className="text-left text-mainTitleBlack flex gap-2">
            ...
            <span className="font-semibold"> &gt; Навчання &gt; Вступ</span>
          </h3>
      ...
      <section className="py-[40px] md:py-[44px] lg:py-[88px] bg-white dark:bg-darkBody">
        <div className="div-container">
          ...
          <p className="p-text">
            ...
            сповнене різних фізичних навантажень, банально щоб випити чаю зранку
            потрібно було нарубати дров, принести їх і розпалити вогонь.{' '}
          </p>
          <p className="p-text">
            Зараз технічний прогрес полегшив наше з вами життя (вчені кажуть в
            10 раз), але людське тіло за 100 кардинально не змінилось і все так
            само створене для фізичних навантажень і здатне пристосовуватись до
            них.{' '}
          </p>
          <p className="p-text">
          ...
          <p className="p-text !font-bold">
            Взагалі наша фізична форма – це результат пристосування до фізичних
            навантажень і харчування. Тобто це динамічна (постійно змінна)
            величина.
          </p>
          <p className="p-text">
            Все досить просто – хочеш виглядати як спортсмен – живи як спортсмен
            (тренування і харчування). Як добре, що для просто гарної фізичної
            форми не потрібно пахати як спортсмен). Для цього достатньо 3 рази в
            тиждень по 1 год. - регулярні тренування протягом тривалого часу. Як
            бонус – ви практично ніколи не будете хворіти. Пропонуємо пройти цей
            шлях з нами.
          </p>
          <p className="p-text">
