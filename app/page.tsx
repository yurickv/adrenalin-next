...
export const metadata: Metadata = {
  ...
  description:
    'Просторий тренажерний зал Адреналін в м.Тернопіль в мікрорайоні БАМ з помірними цінами. Сучасні тренажери, персональний тренер (тренування, харчування, всебічна підтримка), система знижок на абонементи.',
  robots: {
    index: true,
    follow: true,
    nocache: false,
