  ...
  return (
    <div
      className="relative text-center bg-gradient-to-r from-red-500 to-orange-500 text-white
       -mt-12 md:-mt-4 lg:-mt-12 -mx-4 p-4 dark:bg-none dark:bg-[#F15C44]
    after:content-[''] after:absolute after:block after:w-0 after:z-10 after:border-solid 
    after:border-y-hover after:dark:border-y-[#F15C44] after:border-x-white after:dark:border-x-[#676465] 
    after:border-x-[12px] after:border-t-[12px] after:border-b-0
