      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute -left-1/2 md:-left-[400%] z-10 mt-3 w-screen max-w-[290px] md:max-w-[380px] lg:-max-w-[440px] -translate-x-1/2 transform px-0 md:px-4 ">
                <div className="overflow-hidden rounded-lg md:rounded-b-lg md:rounded-tl-lg shadow-lg ring-1 ring-black ring-opacity-5">
