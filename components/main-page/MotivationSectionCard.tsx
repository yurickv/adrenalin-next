    ...
    <div className="w-[670px] text-justify">
      ...
      <ul>
        {cardInfo.map(({ title, text }) => (
          ...
          transition-all duration-300 hover:first:h-[190px] 
          hover:h-[230px] hover:last:h-[260px]"
          >
            ...
            <p
              className="absolute bg-white z-10 font-medium lg:text-xl text-2xl  transition-all 
