            ...
            <li key={index}>
              <FadeIn>
                <details className="p-4 lg:p-5">
                  <summary
                    className="group flex gap-4 items-end justify-between text-lg lg:text-2xl leading-normal font-medium 
               border-b-2 border-main px-3 py-2 cursor-pointer transition-all duration-300 outline-0"
                  >
                  ...
                  <p className="mt-2 bg-white dark:bg-darkBody z-10 font-medium text-lg lg:text-xl lg:leading-8 indent-4 text-mainText dark:text-mainTextBlack">
                    {text}
                  </p>
                </details>
              </FadeIn>
